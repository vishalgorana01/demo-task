...
import {HomeIcon, ListTodoIcon, KanbanSquare, LogOutIcon } from 'lucide-react';
        ...
        <div>
          <SidebarLink
            link={{
              label: "LogOut",
              href: "/",
              icon: <LogOutIcon className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0"/>
            }}
          />
        </div>
      </SidebarBody>
